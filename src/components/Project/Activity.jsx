...
import { postFavoriteProject, postRating } from '../../features/feed/feedActions';
...
const ActivityLineGraph = ({
  ...
  return (
    ...
    >
      <div style={{ position: 'absolute', right: '0rem', top: '1rem', zIndex: 99 }}>
        <TimeSpanIndicator
      ...
      <div style={{ maxHeight: '9rem', height: '100%', width: '100%' }}>
        {currentView === 'lineGraph' ? (
          <GeneralErrorBoundary customMessage='Cannot load the graph'>
            <TimelineGraph uuid={uuid} access_token={access_token} setGraphError={setGraphError} />
