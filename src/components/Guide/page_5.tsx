			...
			<StyledMain>
				...
				<StyledContent>
					<StyledStatement>
						...
						Curated Signals: Deal flows refined by both our experts and yours,
						refined for reporting.
					</StyledStatement>
					<StyledStatement>
						<StyledEmoji>
							<AiIcons.AiOutlineTeam />
						</StyledEmoji>
						Team Reports: Obtain comprehensive insights into the projects your
						investment team are tackling.
					</StyledStatement>
					<StyledStatement>
						<StyledEmoji>
							<BsIcons.BsGraphUp />
